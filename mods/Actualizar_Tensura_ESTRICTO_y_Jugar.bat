...
rem Si cambio pack.toml, se reconstruye STAGING desde cero.
rem Esto evita conservar mods viejos eliminados del pack.
rem ============================================================
echo Comprobando version del pack...
call :Download "%PACKURL%" "%REMOTE_PACK%"
if errorlevel 1 (
    echo.
    echo [ERROR] No se pudo comprobar el pack en GitHub Pages.
    pause
    exit /b 1
)
...
rem /MIR elimina cualquier archivo extra del destino.
rem ============================================================
echo.
...
rem ============================================================
rem TL LEGACY
rem Los argumentos posteriores a -- se envian al launcher.
rem --launch inicia Minecraft automaticamente.
rem ============================================================
